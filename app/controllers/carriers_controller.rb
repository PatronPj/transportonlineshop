class CarriersController < ApplicationController
  ...
  # GET /carriers.json
  def index
    @carriers = Carrier.all.order("created_at desc")
  end
  ...
  # GET /carriers/new
  def new
    @carrier = current_user.carriers.build
  end
  ...
  # POST /carriers.json
  def create
    @carrier = current_user.carriers.build(carrier_params)
  ...
  private
    ...
    def carrier_params
      params.require(:carrier).permit(:surname, :lastname, :description, :price, :image)
    end
end
